...
class RegistrationApp(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text="Teléfono:").grid(row=0, column=1, padx=10, pady=5, sticky="e")
        tk.Label(self, text="Email:").grid(row=1, column=1, padx=10, pady=5, sticky="e")
        tk.Label(self, text="Usuario:").grid(row=0, column=2, padx=10, pady=5, sticky="e")
        tk.Label(self, text="Contraseña:").grid(row=1, column=2, padx=10, pady=5, sticky="e")
        ...
        self.phone_entry.grid(row=0, column=2, padx=10, pady=5)

        self.email_entry = tk.Entry(self, textvariable=self.email)
        self.email_entry.grid(row=1, column=2, padx=10, pady=5)

        self.user_entry = tk.Entry(self, textvariable=self.register_username)
        self.user_entry.grid(row=0, column=3, padx=10, pady=5)

        self.pass_entry = tk.Entry(self, textvariable=self.register_password, show="*")
        self.pass_entry.grid(row=1, column=3, padx=10, pady=5)
